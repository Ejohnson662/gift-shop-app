// Service worker: the app shell is cached so the register opens with no signal; the Apps Script API is never cached.
const CACHE = 'shop-vmtuokgkn';
...
self.addEventListener('fetch', e => {
  ...
  if (e.request.method !== 'GET' || url.origin !== location.origin) return;   // API calls and CDN scripts go straight to the network
